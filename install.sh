...
echo ""
echo -e "  🌐 ${CYAN}Frontend UI (Default):${NC}    ${GREEN}http://${HOST_IP}:3001${NC}"
echo -e "  🌐 ${CYAN}Frontend UI (Standard):${NC}   ${GREEN}http://${HOST_IP}${NC}"
echo -e "  ⚙️  ${CYAN}System Settings:${NC}          ${GREEN}http://${HOST_IP}:3001/settings${NC}"
echo -e "  🔍 ${CYAN}Live Search:${NC}              ${GREEN}http://${HOST_IP}:3001/search${NC}"
echo -e "  📡 ${CYAN}Backend REST API:${NC}         ${GREEN}http://${HOST_IP}:3001/api${NC}"
echo ""
